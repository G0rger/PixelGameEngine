...
public final class VF2D {
    ...
    public VF2D add        (VI2D other)  { return new VF2D(this.x + other.x, this.y + other.y); }
    public VF2D subtract   (VI2D other)  { return new VF2D(this.x - other.x, this.y - other.y); }
    ...
    public VF2D multiply   (VI2D other)  { return new VF2D(this.x * other.x, this.y * other.y); }
    public VF2D divide     (float other) { return new VF2D(this.x / other,   this.y / other);   }
    public VF2D divide     (VI2D other)  { return new VF2D(this.x / other.x, this.y / other.y); }
